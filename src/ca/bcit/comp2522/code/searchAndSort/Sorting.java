...
public final class Sorting {
    ...
    /**
     * Sorts the specified code.arrays of objects using the selection sort algorithm.
     *
    ...
    /**
     * Sorts the specified code.arrays of objects using the insertion sort algorithm.
     *
     * @param <T>  Type placeholder for comparable type
     * @param list Array to be sorted
     */
