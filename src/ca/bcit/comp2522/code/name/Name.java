package ca.bcit.comp2522.code.name;

/**
 * Name represents a three-part ca.bcit.comp2522.code.name.
 *
 * @author BCIT
 * @version 2020
 */
public class Name {
    ...
    /**
     * Default ca.bcit.comp2522.code.name.
     */
    public static final String DEFAULT_FIRST = "Boaty";

    /**
     * Default middle ca.bcit.comp2522.code.name.
     */
    public static final String DEFAULT_MIDDLE = "B";

    /**
     * Default last ca.bcit.comp2522.code.name.
     */
    ...
    /**
     * Returns the first ca.bcit.comp2522.code.name.
     *
    ...
    /**
     * Sets the first ca.bcit.comp2522.code.name.
     *
    ...
    /**
     * Returns the middle ca.bcit.comp2522.code.name.
     *
     * @return middle
     */
    ...
    /**
     * Sets the middle ca.bcit.comp2522.code.name.
     *
    ...
    /**
     * Returns the last ca.bcit.comp2522.code.name.
     *
     * @return last
     */
    ...
    /**
     * Sets the last ca.bcit.comp2522.code.name.
     *
    ...
    /**
     * Returns the length of this ca.bcit.comp2522.code.name.
     *
     * @return length
     */
    ...
    /**
     * Returns true if the specified String is the first ca.bcit.comp2522.code.name.
     *
     ...
     *
     * @return ca.bcit.comp2522.code.name as a String with the components labeled.
     */
    @Override
