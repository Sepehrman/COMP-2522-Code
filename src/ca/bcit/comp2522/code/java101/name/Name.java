package ca.bcit.comp2522.code.java101.name;

/**
 * Name represents a three-part ca.bcit.comp2522.code.java101.name.
 *
 * @author BCIT
 * @version 2020
 */
public class Name {
    ...
    /**
     * Default ca.bcit.comp2522.code.java101.name.
     */
    public static final String DEFAULT_FIRST = "Boaty";

    /**
     * Default middle ca.bcit.comp2522.code.java101.name.
     */
    public static final String DEFAULT_MIDDLE = "B";

    /**
     * Default last ca.bcit.comp2522.code.java101.name.
     */
    ...
    public Name(final String firstName, final String middleName, final String lastName) {
        ...
        if (middleName != null && lastName.trim().length() > 0) {
    ...
    /**
     * Returns the first ca.bcit.comp2522.code.java101.name.
     *
    ...
    /**
     * Sets the first ca.bcit.comp2522.code.java101.name.
     *
    ...
    /**
     * Returns the middle ca.bcit.comp2522.code.java101.name.
     *
     * @return middle
     */
    ...
    /**
     * Sets the middle ca.bcit.comp2522.code.java101.name.
     *
    ...
    /**
     * Returns the last ca.bcit.comp2522.code.java101.name.
     *
     * @return last
     */
    ...
    /**
     * Sets the last ca.bcit.comp2522.code.java101.name.
     *
    ...
    /**
     * Returns the length of this ca.bcit.comp2522.code.java101.name.
     *
     * @return length
     */
    ...
    /**
     * Returns true if the specified String is the first ca.bcit.comp2522.code.java101.name.
     *
     ...
     *
     * @return ca.bcit.comp2522.code.java101.name as a String with the components labeled.
     */
    @Override
